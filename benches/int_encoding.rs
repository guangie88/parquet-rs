...
macro_rules! delta_bit_packed_int {
  ($fname:ident, $batch_size:expr, $low:expr, $high:expr) => {
    #[bench]
    fn $fname(bench: &mut Bencher) {
...
delta_bit_packed_int!(delta_bit_packed_i32_1m_10, 1024 * 1024, 0, 10);
delta_bit_packed_int!(delta_bit_packed_i32_1m_100, 1024 * 1024, 0, 100);
delta_bit_packed_int!(delta_bit_packed_i32_1m_1000, 1024 * 1024, 0, 1000);
